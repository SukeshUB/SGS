...
/**
 * FScreen - FScreen class for the first screen for the UI, In this screen UI
 * asks user for number of users and previously existing scores
 */
public class FScreen {
	...
	/**
	 * main - this is the starting point of the execution of first screen and the
	 * entire software
	 */
	...
	/**
	 * FScreen - This method initializes the first screen by calling initialize
	 * method
	 */
	public FScreen() {
		initialize();
	...
	/**
	 * initialize - This method initialize the contents of the frame. It asks for
	 * number of team members and previously entered score As soon as submit button
	 * is pressed a transition is done to second screen.
	 */
